			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				?>
					...
					<?php if (et_get_option('divi_integration_single_bottom') <> '' && et_get_option('divi_integrate_singlebottom_enable') == 'on') echo(et_get_option('divi_integration_single_bottom')); 
						...
						echo do_shortcode( '[et_pb_post_nav admin_label="Post Navigation" in_same_term="off" hide_prev="off" hide_next="off" prev_text="Previous Post" next_text="Next Post" use_border_color="off" border_color="#ffffff" border_style="solid" /]' );
					?>
