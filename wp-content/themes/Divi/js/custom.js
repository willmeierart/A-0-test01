	...
	$(document).ready( function(){
		...
		$( 'a[href*="#"]:not([href="#"])' ).click( function() {
			var $this_link = $( this ),
				...
				disable_scroll = has_closest_smooth_scroll_disabled || has_closest_woocommerce_tabs || has_closest_eab_cal_link || has_acomment_reply || is_woocommerce_review_link || has_closest_timetable_tab;
