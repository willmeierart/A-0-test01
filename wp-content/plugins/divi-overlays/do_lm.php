...
if ( ! class_exists( 'do_lm' ) ) {
	class do_lm {
		 ...
		 */
		public $file             = '';
		public $software_title   = 'Divi Overlays';
		public $software_version = '2.0';
		public $plugin_or_theme  = 'plugin';
		public $api_url          = 'https://divilife.com/';
		public $data_prefix      = '';
		public $slug             = '';
		public $plugin_name      = 'Divi Overlays';
		public $text_domain      = 'Divi Overlays';
		public $extra            = '';
		...
		public function wc_am_api_key_field() {
			echo "<input type='password' id='api_key' name='" . $this->ame_data_key . "[" . $this->ame_api_key . "]' size='25' type='text' value='" . $this->ame_options[ $this->ame_api_key ] . "' />";
		...
		public function wc_am_api_email_field() {
			echo "<input type='password' id='activation_email' name='" . $this->ame_data_key . "[" . $this->ame_activation_email . "]' size='25' type='text' value='" . $this->ame_options[ $this->ame_activation_email ] . "' />";
