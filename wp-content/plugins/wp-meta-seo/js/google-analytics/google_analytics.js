    ...
    wpmsItemReport: function (itemId) {
        ...
        template = {
            ...
            init: function () {
                ...
                if (!jQuery('#wpms-window' + slug).length) {
                    return;
                }

                if (jQuery('#wpms-window' + slug).html().length) { // add main template once
                    return;
                }
                ...
                tpl += '</div>',
                jQuery('#wpms-window' + slug).append(tpl);
        ...
        reports = {
            ...
            alertMessage: function (msg) {
                ...
                jQuery("#wpms-status" + slug).html(msg);
            },
            ...
            throwDebug: function (response) {
                ...
                if (response == '-24') {
                    ...
                    jQuery("#wpms-reports" + slug).html(response);
                    jQuery("#wpms-reports" + slug).show();
            ...
            render: function (view, period, query) {
                ...
                if (wpmsItemData.scope == 'admin-item') {
                    postData = {
                        action: 'wpms_backend_item_reports',
                    ...
                    postData = {
                        action: 'wpms_frontend_item_reports',
