<div id="post-body-content">
    <div class="settings-wrapper">
        ...
        $lists_dimension = array(
            'Disabled','dimension 1', 'dimension 2', 'dimension 3', 'dimension 4', 'dimension 5', 'dimension 6', 'dimension 7', 'dimension 8', 'dimension 9', 'dimension 10',
            'dimension 11', 'dimension 12', 'dimension 13', 'dimension 14', 'dimension 15', 'dimension 16', 'dimension 17', 'dimension 18', 'dimension 19', 'dimension 20'
        );
                ...
                <div id="wpmsga-basic">
                    <table class="wpmsga-settings-options">
                        <tbody>
                            ...
                            <tr>
                                <td class="wpmsga-settings-title"><label for="wpmsga_dash_tracking"><?php _e('Tracking Options:', 'wp-meta-seo') ?></label></td>
                                <td>
                                    <select id="wpmsga_dash_tracking" name="_metaseo_ggtracking_settings[wpmsga_dash_tracking]" onchange="this.form.submit()">
                                        <option value="0" <?php selected($this->ga_tracking['wpmsga_dash_tracking'], 0) ?>><?php _e('Disabled', 'wp-meta-seo') ?></option>
                                        <option value="1" <?php selected($this->ga_tracking['wpmsga_dash_tracking'], 1) ?>><?php _e('Enabled', 'wp-meta-seo') ?></option>
                                    </select>
                                    <div class="wpmsga_clear_author">
                                        <input type="button" name="wpmsClearauthor" class="wpmsClearauthor button button-secondary" value="<?php _e("!Remove tracking authorization!", 'wp-meta-seo') ?>">
                            ...
                            <tr>
                                <td class="wpmsga-settings-title"><label for="wpmsga_dash_tracking"><?php _e('Analytics profile:', 'wp-meta-seo') ?></label></td>
                                <td>
                                    ...
                                    if (!empty($this->google_alanytics['profile_list'])) {
                                        foreach ($this->google_alanytics['profile_list'] as $items) {
                                            if ($items[3]) {
                                                echo '<optgroup label="' . esc_html(WPMSGA_Tools::strip_protocol($items[3])) . '">';
                                                if (isset($this->google_alanytics['tableid_jail']) && $this->google_alanytics['tableid_jail'] == $items[1]) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    if(isset($this->google_alanytics['tableid_jail']) && isset($this->google_alanytics['profile_list'])){
                                        $profile_info = WPMSGA_Tools::get_selected_profile($this->google_alanytics['profile_list'], $this->google_alanytics['tableid_jail']);
                                        if (!empty($profile_info[0]) && !empty($this->ga_tracking['wpmsga_dash_tracking'])) {
                                            echo '<pre>View Name:	' . $profile_info[0] . '<br>Tracking ID:	' . $profile_info[2] . '<br>Default URL:	' . $profile_info[3] . '<br>Time Zone:	' . $profile_info[5] . '</pre>';
                                        }
                                    }
                                    ?>
                                </td>
                            ...
                            <tr>
                                <td colspan="2"><hr><h2><?php _e('Basic Tracking', 'wp-meta-seo') ?></h2></td>
                            </tr>
                            <tr>
                                <td class="wpmsga-settings-title"><label for="wpmsga_dash_tracking_type"><?php _e('Tracking Type:', 'wp-meta-seo') ?></label></td>
                                <td><select id="wpmsga_dash_tracking_type" name="_metaseo_ggtracking_settings[wpmsga_dash_tracking_type]">
                                        <option value="classic" <?php selected($this->ga_tracking['wpmsga_dash_tracking_type'], 'classic') ?>><?php _e('Classic Analytics', 'wp-meta-seo') ?></option>
                                        <option value="universal" <?php selected($this->ga_tracking['wpmsga_dash_tracking_type'], 'universal') ?>><?php _e('Universal Analytics', 'wp-meta-seo') ?></option>
                                    </select></td>
                            </tr>
                            <tr>
                ...
                <div id="wpmsga-events">
                    <table class="wpmsga-settings-options">
                        <tbody><tr>
                            ...
                            <tr>
                                <td class="wpmsga-settings-title"><label for="wpmsga_event_downloads"><?php _e('Downloads Regex:', 'wp-meta-seo') ?></label></td>
                                <td><input type="text" id="wpmsga_event_downloads" name="_metaseo_ggtracking_settings[wpmsga_event_downloads]" value="<?php echo $this->ga_tracking['wpmsga_event_downloads'] ?>" size="50"></td>
                            </tr>
                        </tbody></table>
                </div>
                ...
                <div id="wpmsga-exclude">
                    <table class="wpmsga-settings-options">
                        <tbody><tr>
                            ...
                            <tr>
                                <td class="roles wpmsga-settings-title"><label for="wpmsga_track_exclude"><?php _e('Exclude tracking for:', 'wp-meta-seo') ?></label></td>
