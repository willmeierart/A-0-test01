<form name="ga_dash_form" method="post" action="">
    ...
    <tbody><tr>
        ...
        <tr>
            ...
            <td><input type="text" name="wpmsga_dash_clientid" value="<?php echo (!empty($this->google_alanytics['wpmsga_dash_clientid']))?$this->google_alanytics['wpmsga_dash_clientid']:"" ?>" size="40" required="required"></td>
        </tr>
        <tr>
            <td class="gadwp-settings-title"><label><?php _e('Client Secret:','wp-meta-seo') ?></label></td>
            <td>
                <input type="text" name="wpmsga_dash_clientsecret" value="<?php echo (!empty($this->google_alanytics['wpmsga_dash_clientsecret']))?$this->google_alanytics['wpmsga_dash_clientsecret']:"" ?>" size="40" required="required">
            </td>
        </tr>
        <tr>
            <td colspan="2"><hr></td>
